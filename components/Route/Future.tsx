...
const Future = (props: Props) => {
  return (
    <div className="w-full bg-contain  relative p-4 md:p-[unset] grid md:grid-cols-2 py-8">
      <div className="col-span-1">
        <Image
          src={"https://i.pinimg.com/564x/fd/74/7e/fd747e799f328b37fa449094ca76e8e0.jpg"}
          width={800}
          height={500}
          alt=""
      ...
      <div className="col-span-1 w-full flex justify-center items-center">
        <div className="2xl:w-[60%]">
          ...
          <h5 className={`${styles.heading} mb-5 !leading-[90px]`}>
